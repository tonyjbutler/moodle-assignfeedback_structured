...
$string['criteriasetconfirmdelete'] = 'Are you sure? Your criteria set "{$a}" will be permanently deleted.';
...
$string['criteriasetsowned'] = 'Owned criteria sets';
...
$string['defaultcritname_help'] = 'Optional default name for the first feedback criterion in all new assignments.';
$string['disable'] = 'Disable structured feedback';
$string['enable'] = 'Enable structured feedback to edit criteria';
