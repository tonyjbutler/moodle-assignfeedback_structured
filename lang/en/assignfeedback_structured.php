...
$string['criteriasetpublish'] = 'Make available to other users';
$string['criteriasetpublish_help'] = 'Tick this box to enable anyone to make a copy of this criteria set. By default it is available only to the user who created it.';
...
$string['nopublicsets'] = 'There are currently no shared sets available.';
