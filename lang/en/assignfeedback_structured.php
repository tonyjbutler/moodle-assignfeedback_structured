...
$string['criteriasetname_help'] = 'The name of a criteria set must be unique across the whole site, so choose carefully.';
...
$string['criteriontitle'] = '{$a->name}: {$a->desc}';
...
$string['savecriteriaset_help'] = 'Tick this box and provide a unique name for your criteria set if you want to be able to copy it easily into other assignments. Once a criteria set is saved, others users will be unable to edit it (or any of its criteria).';
