...
$string['criteriasetname_help'] = 'The name of a criteria set must be unique across the whole site, so choose carefully. Once a criteria set is saved, others users will be unable to edit it (or any of its criteria).';
...
$string['criteriasetpublic_help'] = 'Tick this box to enable anyone to make a copy of this criteria set. By default it is available only to you.';
